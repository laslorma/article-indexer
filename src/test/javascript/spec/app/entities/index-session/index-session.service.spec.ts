...
describe('Service Tests', () => {
  describe('IndexSession Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a IndexSession', async () => {
        const returnedFromService = Object.assign(
          {
            id: 0,
            started: currentDate.format(DATE_TIME_FORMAT),
      ...
      it('should update a IndexSession', async () => {
        const returnedFromService = Object.assign(
          {
            newsApiCalls: 1,
      ...
      it('should return a list of IndexSession', async () => {
        const returnedFromService = Object.assign(
          {
            newsApiCalls: 1,
            fiveFilterApiCalls: 1,
      ...
      it('should delete a IndexSession', async () => {
