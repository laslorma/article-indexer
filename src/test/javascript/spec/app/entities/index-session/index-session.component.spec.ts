...
import { IndexSessionComponent } from 'app/entities/index-session/index-session.component';
...
describe('Component Tests', () => {
  describe('IndexSession Management Component', () => {
    let comp: IndexSessionComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(IndexSessionComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.indexSessions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
