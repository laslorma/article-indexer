...
import { ParagraphComponent } from 'app/entities/paragraph/paragraph.component';
...
describe('Component Tests', () => {
  describe('Paragraph Management Component', () => {
    let comp: ParagraphComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ParagraphComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.paragraphs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
