...
describe('Service Tests', () => {
  describe('Paragraph Service', () => {
    let injector: TestBed;
    let service: ParagraphService;
    let httpMock: HttpTestingController;
    let elemDefault: IParagraph;
    let expectedResult;
    beforeEach(() => {
      ...
      expectedResult = {};
      injector = getTestBed();
      service = injector.get(ParagraphService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new Paragraph(0, 'AAAAAAA', 'AAAAAAA', 0, false, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should return a list of Paragraph', async () => {
        const returnedFromService = Object.assign(
          {
            content: 'BBBBBB',
            originalCleanedContent: 'BBBBBB',
